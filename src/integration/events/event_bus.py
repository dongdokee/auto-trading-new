...
class EventBusMetrics:
    """Event bus performance and health metrics"""
    ...
    def __init__(self):
        ...
        self.processing_latency_history = deque(maxlen=100)
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        avg_queue_size = (
            sum(self.queue_size_history) / len(self.queue_size_history)
            if self.queue_size_history else 0.0
        )
...
class EventBus:
    ...
    def __init__(self,
        ...
        # Event persistence
        self.event_history: deque = deque(maxlen=persistence_buffer_size)
        self.failed_events: deque = deque(maxlen=persistence_buffer_size)
